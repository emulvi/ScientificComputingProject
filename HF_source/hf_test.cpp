...
if (abs(abs(En)-74.9421)<=pow(10,-4)){cout << "Test passed" << endl;}else{cout << "Test failed" << endl;}
...
if (abs(abs(En_nuc)-8.002367061810450)<=pow(10,-8)){cout << "Test passed" << endl;}else{cout << "Test failed" << endl;}
